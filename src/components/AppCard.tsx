...
export function AppCard() {
  ...
  const contentSharedMotionProps = {
    initial: false,
    transition: { duration: 0.3 },
  };

  return (
    <Card className="w-full md:w-5/6 lg:w-9/12 2xl:w-1/2">
      <motion.div
      ...
      >
        ...
        <CardHeader className="lg:mb-4">
          <motion.div
            className={cn({ hidden: !isCalculator })}
            {...contentSharedMotionProps}
            animate={{
              opacity: isCalculator ? 1 : 0,
              pointerEvents: isCalculator ? "auto" : "none",
            }}
          >
        ...
        <CardContent className="w-full text-lg">
          <motion.div
            className={cn("flex flex-col", { hidden: !isCalculator })}
            {...contentSharedMotionProps}
            animate={{
              opacity: isCalculator ? 1 : 0,
              pointerEvents: isCalculator ? "auto" : "none",
          ...
          <motion.div
            className={cn("flex, flex-col p-6 lg:p-8", {
              hidden: isCalculator,
            })}
            {...contentSharedMotionProps}
            animate={{
        ...
        <CardFooter className="w-full flex flex-col gap-2">
          <motion.div
            className={cn("border p-4 w-full mb-4", { hidden: !isCalculator })}
            {...contentSharedMotionProps}
            animate={{
              opacity: isCalculator ? 1 : 0,
              pointerEvents: isCalculator ? "auto" : "none",
